...
/* harmony import */ var _modules_more_text_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/more-text-button */ "./js/modules/more-text-button.js");
/* harmony import */ var _modules_consultation_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/consultation-button */ "./js/modules/consultation-button.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_more_text_button__WEBPACK_IMPORTED_MODULE_2__["showMoreTextButton"])();
  Object(_modules_consultation_button__WEBPACK_IMPORTED_MODULE_3__["changeTextButton"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["runAccordion"])();
  Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__["initPhoneMask"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: runAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runAccordion", function() { return runAccordion; });
var accordionTitles = document.querySelectorAll('.footer__accordion-title');
var accordionWrappers = document.querySelectorAll('.footer__accordion-wrapper');
  ...
  accordionTitles.forEach(function (item) {
    ...
    item.addEventListener('click', function () {
      ...
      if (parent.classList.contains('footer__accordion-item--active')) {
        ...
        document.querySelectorAll('.footer__accordion-item').forEach(function (child) {
...
/***/ "./js/modules/consultation-button.js":
/*!*******************************************!*\
  !*** ./js/modules/consultation-button.js ***!
  \*******************************************/
...
var consultButton = document.querySelector('.button--blue');
...
/***/ "./js/modules/more-text-button.js":
/*!****************************************!*\
  !*** ./js/modules/more-text-button.js ***!
  \****************************************/
/*! exports provided: showMoreTextButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showMoreTextButton", function() { return showMoreTextButton; });
var aboutButton = document.querySelector('.about__button');
var hiddenText = document.querySelectorAll('.about__text--hidden');
var componentsText = document.querySelector('.about__text--components');

var showMoreTextButton = function showMoreTextButton() {
  aboutButton.addEventListener('click', function () {
    hiddenText.forEach(function (elem) {
...
var phoneInputMain = document.querySelector('.contacts__phone');
var phoneInputModal = document.querySelector('.modal__phone-input');
var maskOptions = {
  mask: '+{7}(000)000-00-00'
};

var initPhoneMask = function initPhoneMask() {
  Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(phoneInputMain, maskOptions);
  Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(phoneInputModal, maskOptions);
};
